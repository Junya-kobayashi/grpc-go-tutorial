...
func (x *SquareRootRequest) Reset() {
	*x = SquareRootRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_caluculator_caluculatorpb_caluculator_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SquareRootRequest) Descriptor() ([]byte, []int) {
	return file_caluculator_caluculatorpb_caluculator_proto_rawDescGZIP(), []int{9}
}
...
func (x *SquareRootResponse) Reset() {
	*x = SquareRootResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_caluculator_caluculatorpb_caluculator_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SquareRootResponse) Descriptor() ([]byte, []int) {
	return file_caluculator_caluculatorpb_caluculator_proto_rawDescGZIP(), []int{10}
}
...
var file_caluculator_caluculatorpb_caluculator_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x6f, 0x6f, 0x74, 0x32, 0xff, 0x02, 0x0a, 0x12, 0x43, 0x61,
	0x6c, 0x75, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x52, 0x0a, 0x0b, 0x50, 0x72,
	0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x1e, 0x2e, 0x63, 0x61, 0x6c, 0x63,
	...
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x46,
	...
	0x6f, 0x72, 0x2e, 0x61, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x44, 0x0a, 0x03, 0x4d, 0x61, 0x78, 0x12, 0x1a, 0x2e,
	0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x6d, 0x61, 0x78, 0x69, 0x6d,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1c, 0x5a, 0x1a, 0x63,
	0x61, 0x6c, 0x75, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x63, 0x61, 0x6c, 0x75, 0x63,
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x70, 0x62, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_caluculator_caluculatorpb_caluculator_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_caluculator_caluculatorpb_caluculator_proto_depIdxs = []int32{
	...
	9,  // 5: calculator.CaluculatorService.SquareRoot:input_type -> calculator.SquareRootRequest
	5,  // 6: calculator.CaluculatorService.Sum:output_type -> calculator.SumResponse
	6,  // 7: calculator.CaluculatorService.PrimeNumber:output_type -> calculator.primeNumberResponse
	7,  // 8: calculator.CaluculatorService.Average:output_type -> calculator.averageResponse
	8,  // 9: calculator.CaluculatorService.Max:output_type -> calculator.maximumResponse
	10, // 10: calculator.CaluculatorService.SquareRoot:output_type -> calculator.SquareRootResponse
...
func file_caluculator_caluculatorpb_caluculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_caluculator_caluculatorpb_caluculator_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_caluculator_caluculatorpb_caluculator_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
...
func (c *caluculatorServiceClient) SquareRoot(ctx context.Context, in *SquareRootRequest, opts ...grpc.CallOption) (*SquareRootResponse, error) {
	out := new(SquareRootResponse)
	err := c.cc.Invoke(ctx, "/calculator.CaluculatorService/SquareRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCaluculatorServiceServer) SquareRoot(context.Context, *SquareRootRequest) (*SquareRootResponse, error) {
...
func _CaluculatorService_SquareRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SquareRootRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CaluculatorServiceServer).SquareRoot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CaluculatorService/SquareRoot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaluculatorServiceServer).SquareRoot(ctx, req.(*SquareRootRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CaluculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CaluculatorService_SquareRoot_Handler,
		},
	},
